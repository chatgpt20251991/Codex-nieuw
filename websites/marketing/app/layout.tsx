...
import "./globals.css";
export const metadata: Metadata = {metadataBase:new URL("https://eubatterypassport.nl"),title:{default:"EUBatteryPassport — Elke batterij. Eén helder paspoort.",template:"%s | EUBatteryPassport"},description:"Van batterijdata en bewijsstukken tot het opstellen en beheren van digitale batterijpaspoorten. Voor fabrikanten, importeurs en distributeurs.",icons:{icon:"/images/symbol-v5-64.png"}};
