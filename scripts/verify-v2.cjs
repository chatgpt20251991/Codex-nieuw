...
ok('public projection strips evidence IDs', passport.includes('publicJson') && passport.includes('map((v:any)=>({fieldId:v.fieldId,name:v.name,value:v.value,unit:v.unit}))'));
