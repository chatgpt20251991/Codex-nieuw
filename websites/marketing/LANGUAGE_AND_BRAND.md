...
The mobile header keeps the complete brand, language flag and menu on one vertically centred row. At narrow widths the flag retains its accessible language label while the visible EN/NL abbreviation is hidden to preserve space for the complete domain. The intake link remains in the mobile menu.
