...
export function IntakeForm(){
 ...
 <div className="form-field"><label htmlFor="message">Waar kunnen we je mee helpen? <span className="form-small">(optioneel)</span></label><Textarea id="message" name="message" maxLength={3000} placeholder="Vertel kort over je vraag en de informatie die je al hebt."/></div>
 ...
 <p className="form-small">We gebruiken je gegevens om je aanvraag te behandelen. Lees onze <a href="/privacy">privacyverklaring</a>. Deel hier geen vertrouwelijke documenten of bijzondere persoonsgegevens.</p>
